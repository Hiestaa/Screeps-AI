module.exports = function (grunt) {
    ...
    grunt.registerTask('default',  ['clean', 'eslint', 'copy:screeps',  'file_append:versioning', 'screeps']);
    grunt.registerTask('private',  ['clean', 'eslint', 'copy:screeps',  'file_append:versioning', 'rsync:private']);
    grunt.registerTask('test',     ['eslint', 'jsbeautifier:verify', ]);
    grunt.registerTask('pretty',   ['eslint', 'jsbeautifier:modify']);
};
