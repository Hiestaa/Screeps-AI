/**
 * Utilities that modify the prototypes of game objects.
 * This module does not export any definition, but importing it will add new methods
 * to existing objects, or improve existing ones.
 */
